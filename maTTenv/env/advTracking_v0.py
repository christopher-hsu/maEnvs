...
Varying number of moving adversarial targets that avoid agents
No obstacles

advTrackingEnv0 : Double Integrator Target model with KF belief tracker
...
class advTrackingEnv0(maTrackingBase):
    ...
    def setup_targets(self):
        self.targets = [AgentDoubleInt2D_Avoidance(agent_id = 'target-' + str(i),
